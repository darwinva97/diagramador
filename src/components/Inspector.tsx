  ...
  return (
    <>
      ...
      <ul className="help">
        ...
        <li><b>Cabeceras fijas:</b> los botones ⇤ y ⤒ de la barra superior mantienen a la vista la columna de capas y la fila de etapas mientras te desplazas. También desde el clic derecho en una capa o una etapa.</li>
